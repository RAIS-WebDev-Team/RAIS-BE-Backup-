...
try {
    ...
    if ($service) {
        ...
        $service = [
            ...
            'hero_image_path' => 'img/Fwork.jpg',
            'hero_title' => 'Work Permit',
            'hero_description' => 'A work permit allows individuals to work legally in a specific country, often requiring employer sponsorship or meeting eligibility criteria. For caregivers, additional requirements may include qualifications and a positive Labour Market Impact Assessment (LMIA).'
        ];
    }
        ...
        <div class="tab-content tab-section-content fs-6">
          <div class="tab-pane fade show active" id="about" role="tabpanel">
            <div class="row align-items-center g-4">
              ...
              <div class="col-lg-6 text-center">
                <img src="../<?php echo htmlspecialchars($tabs['about']['image_path']); ?>" alt="Work Image" class="img-fluid rounded tab-image" />
              </div>
            </div>
          </div>
          ...
          <div class="tab-pane fade" id="criteria" role="tabpanel">
            <div class="row align-items-center g-4">
              <div class="col-lg-4 text-center">
                <img src="../<?php echo htmlspecialchars($tabs['criteria']['image_path']); ?>" alt="Criteria Image" class="img-fluid rounded tab-image" />
              </div>
          ...
          <div class="tab-pane fade" id="process" role="tabpanel">
            <div class="row align-items-center g-4">
              ...
              <div class="col-lg-4 text-center">
                <img src="../<?php echo htmlspecialchars($tabs['process']['image_path']); ?>" alt="Process Image" class="img-fluid rounded tab-image" />
              </div>
            </div>
          </div>
          ...
          <div class="tab-pane fade" id="documents" role="tabpanel">
            <div class="row align-items-center g-4">
              <div class="col-lg-4 text-center">
                <img src="../<?php echo htmlspecialchars($tabs['documents']['image_path']); ?>" alt="A collection of important documents"
