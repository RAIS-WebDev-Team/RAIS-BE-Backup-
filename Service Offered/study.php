...
try {
    ...
    if ($service) {
        ...
        $service = [
            'page_title' => 'Study Permit',
            'hero_image_path' => 'img/Fstudy.jpg',
            'hero_title' => 'Study Permit',
            'hero_description' => 'A study permit allows individuals to study legally in a country, requiring proof of enrollment and financial stability. In some countries, like the Philippines, it is also necessary for obtaining a driver’s license.'
        ];
    }
            ...
            <div class="container-lg">
              <div class="row align-items-center g-4">
                ...
                <div class="col-md-6 text-center">
                  <img src="../<?php echo htmlspecialchars($tabs['about']['image_path']); ?>" alt="Study Image" class="img-fluid rounded tab-image" />
                </div>
              </div>
            </div>
          </div>
