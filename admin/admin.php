...
/*
* --- DEBUGGING STEP ---
* If you are still being redirected, uncomment the following two lines
* to see what is in the session when you land on this page.
* If the array is empty, the session is not being passed correctly from signin.php.
* If it has data, check that the 'role' is what you expect.
*/
// var_dump($_SESSION);
// exit();


// Security Check: Ensure user is logged in and has a role containing "Admin".
// Using stripos for a case-insensitive check is more robust (handles 'Admin', 'admin', 'Super Admin', etc.).
if (!isset($_SESSION['loggedin']) || $_SESSION['loggedin'] !== true || !isset($_SESSION['role']) || stripos($_SESSION['role'], 'Admin') === false) {
...
<head>
    ...
    <style>
        ...
        /* Custom button style for dark mode */
            ...
            <main class="main-content">
                ...
                <div class="content-card">
                    ...
                    <div class="d-flex justify-content-start mt-3">
                        <a href="user_management.php" class="btn btn-outline-dark" role="button"><i class="bi bi-people me-2"></i>Manage Users</a>
                    </div>
                </div>
